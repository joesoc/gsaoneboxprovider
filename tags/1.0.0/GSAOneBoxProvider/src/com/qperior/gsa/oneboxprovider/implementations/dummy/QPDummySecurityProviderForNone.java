...
/**
 * Just a dummy implementation for the {@link QPAbstractSecurityProvider}. 
 * It just supports the auth type "none".
 * 
 * @author Ralf Ovelgoenne
 *
 */
public class QPDummySecurityProviderForNone extends QPAbstractSecurityProvider {
